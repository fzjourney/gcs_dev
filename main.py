...
class DroneControlApp:
    def __init__(self, tello_manager):
        ...
        self.last_command_time = 0  # waktu perintah terakhir dikirim

    def run(self):
        AXIS_THRESHOLD = 0.3
        COMMAND_INTERVAL = 0.2  # Interval minimum antar perintah dalam detik
            ...
            if self.tello_manager.start_video_stream():
                ...
                try:
                    while True:
                        ...
                        # Mengirim perintah hanya jika interval terpenuhi
                        if current_time - self.last_command_time >= COMMAND_INTERVAL:
                            self.process_joystick_inputs()  # Proses input dari joystick
                            self.last_command_time = current_time  # Update waktu perintah terakhir
